...
export function About() {
  const { t } = useLang();
  return (
    <section id="about" className="py-32 md:py-48 px-[5vw] cinematic-band section-depth">
      <div className="mx-auto max-w-[900px] text-center">
        ...
        <div className="mt-12 space-y-6 text-base md:text-[1.0625rem] text-ink-soft leading-[1.85] font-light">
          <p>{t.about.p1}</p>
          <p>{t.about.p2}</p>
        </div>
        <figure className="mt-16 relative inline-block max-w-[44ch] mx-auto">
          ...
          <blockquote className="font-serif italic text-2xl md:text-3xl text-foreground leading-[1.4]">
            {t.about.quote}
          </blockquote>
