      ...
      <div className="mx-auto max-w-[1500px]">
        <div className="flex flex-col md:flex-row md:items-end md:justify-between mb-16 md:mb-24 gap-6">
          ...
          <a href="#works" className="group inline-flex items-center gap-4 self-start md:self-end">
            ...
            <span className="block h-px w-10 bg-foreground transition-all duration-700 group-hover:w-16" />
          </a>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-8 md:gap-10">
          {items.map((a, i) => (
            ...
            >
              <div className="relative overflow-hidden bg-bone shadow-soft art-vignette aspect-[4/5]">
                <img
                  src={a.image}
                  alt={a.title}
                  loading="lazy"
